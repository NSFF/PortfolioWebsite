...
export class SkillsComponent implements OnInit {
  ...
  frameworkChartLabels= ['Keras', 'Scikit-learn', 'Seaborn', 'Laravel', 'PyTorch', 'MySQL', 'TensorFlow', 'NN4j', 'Angular', 'AWS', 'Git', 'Docker', 'SPSS'];
  frameworkChartLegend = true;
  frameworkChartPlugins = [pluginDataLabels];
  frameworkChartData = [
    {data: [4,3,3,3,2,2,2,2,2,2,2,2,2], label: ['Frameworks and Software'], backgroundColor: ["rgba(3, 117, 13, 0.5)","rgb(0, 187, 255,0.5)"], hoverBackgroundColor: ["rgba(3, 117, 13)", "rgb(0, 187, 255)"]},
  ]
